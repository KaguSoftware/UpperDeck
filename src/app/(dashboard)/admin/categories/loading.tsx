    ...
    <div className="min-h-screen flex">
      ...
      <main className="flex-1 p-6 flex flex-col gap-6">
        ...
        <div className="border-2 border-green bg-white">
          <div className="grid grid-cols-[4rem_3rem_1fr_1fr_1fr_12rem] gap-3 px-4 py-3 bg-bg-deep border-b-2 border-green">
            {[...Array(6)].map((_, i) => (
          ...
          {[...Array(6)].map((_, i) => (
            <div
              key={i}
              className="grid grid-cols-[4rem_3rem_1fr_1fr_1fr_12rem] gap-3 px-4 py-3 border-b border-green/20 items-center"
            >
