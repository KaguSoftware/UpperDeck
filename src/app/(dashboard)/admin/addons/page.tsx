    ...
    <>
      ...
      {groups.length === 0 && (
        <p className="text-green/60 font-ui text-[13px]">
          ...
          to show extras in the item modal.
        </p>
      )}
      ...
      <table className="w-full text-left border-collapse">
        <thead>
          <tr className="border-b-2 border-green bg-green/5">
            <th className="px-4 py-2.5 font-ui font-extrabold text-[10px] tracking-[0.2em] uppercase text-green">Scope</th>
            <th className="px-4 py-2.5 font-ui font-extrabold text-[10px] tracking-[0.2em] uppercase text-green">Group Label</th>
            <th className="px-4 py-2.5 font-ui font-extrabold text-[10px] tracking-[0.2em] uppercase text-green">Type</th>
            <th className="px-4 py-2.5 font-ui font-extrabold text-[10px] tracking-[0.2em] uppercase text-green">Options</th>
